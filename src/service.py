...
class SpotifyService:
    ...
    def _try_initialize_from_cache(self) -> None:
        ...
        try:
            if not SPOTIFY_CLIENT_ID or not SPOTIFY_CLIENT_SECRET:
                logger.warning(
                    "SPOTIFY_CLIENT_ID e SPOTIFY_CLIENT_SECRET não configurados"
                )
                self.client = None
                return
            ...
            if token_info and not auth_manager.is_token_expired(token_info):
                ...
                logger.info(
                    "Cache inválido ou inexistente, cliente não inicializado "
                    "automaticamente"
                )
                self.client = None
    ...
    def reauthenticate(self) -> Dict[str, str]:
        ...
        try:
            if not SPOTIFY_CLIENT_ID or not SPOTIFY_CLIENT_SECRET:
                raise ValueError(
                    "SPOTIFY_CLIENT_ID e SPOTIFY_CLIENT_SECRET devem estar configurados"
                )
        ...
        try:
            ...
            if not active_devices:
                ...
                available_devices = [
                    ...
                    if d["type"] in ["Computer", "Smartphone", "Tablet"]
                ]
                if available_devices:
                    ...
                    logger.info(
                        f"Playback transferido para: {available_devices[0]['name']}"
                    )
                else:
    ...
    def skip_to_next(self) -> Dict[str, str]:
        ...
        try:
            ...
            if "restriction violated" in error_msg or "403" in error_msg:
                return {
                    "message": "Não é possível pular para próxima música neste momento",
                    "warning": "Restrição do Spotify",
                }
            else:
    ...
    def skip_to_previous(self) -> Dict[str, str]:
        ...
        try:
            ...
            if "restriction violated" in error_msg or "403" in error_msg:
                return {
                    "message": "Não é possível voltar para música anterior neste momento",
                    "warning": "Restrição do Spotify",
                }
            else:
    ...
    def get_top_artists(self) -> Dict[str, List[Dict[str, Any]]]:
        ...
        try:
            ...
            if "403" in str(e) or "Insufficient client scope" in str(e):
                raise ValueError(
                    "Permissão insuficiente. Reautentique com escopo 'user-top-read'"
                )
    ...
    def auto_transfer_playback(self) -> Dict[str, str]:
        ...
        try:
            ...
            self.client.transfer_playback(device_id=device_id)
            return {
                "message": f"Playback transferido automaticamente para: {device_name}"
            }
        except Exception as e:
    ...
    def toggle_shuffle(self) -> Dict[str, str]:
        ...
        try:
            ...
            if current_state:
                ...
                return {
                    "message": f"Shuffle {'ativado' if new_state else 'desativado'}"
                }
            return {"message": "Nenhuma música tocando"}
        except Exception as e:
    ...
    def get_recommendations(
        ...
        try:
            ...
            if "403" in str(e) or "Insufficient client scope" in str(e):
                raise ValueError(
                    "Permissão insuficiente. Reautentique com o endpoint /auth/reauth"
                )
            elif "404" in str(e):
                raise ValueError(
                    "API de recomendações temporariamente indisponível. Tente novamente mais tarde."
                )
    ...
    def get_audio_features(self, track_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not features or not features[0]:
                return {
                    "features": None,
                    "message": "Características de áudio não disponíveis",
                }
    ...
    def get_track_tempo(self, track_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "track_id": track_id,
                "description": (
                    f"Batida: {tempo} BPM" if tempo else "Tempo não disponível"
                ),
            }
        except Exception as e:
            error_text = str(e)
    ...
    def get_audio_features_by_uri(self, track_uri: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ValueError(
                f"Erro ao obter características de áudio por URI: {str(e)}"
            )
    ...
    def add_track_to_favorites(self, track_id: str) -> Dict[str, str]:
        ...
        try:
            ...
            return {"message": "Música adicionada aos favoritos com sucesso"}
        except Exception as e:
    ...
    def remove_track_from_favorites(self, track_id: str) -> Dict[str, str]:
        ...
        try:
            ...
            return {"message": "Música removida dos favoritos com sucesso"}
        except Exception as e:
    ...
    def get_listening_analytics(self, limit: int = 50) -> Dict[str, Any]:
        ...
        try:
            ...
            analytics["summary"] = {
                ...
                "most_played_artist": self._get_most_played_artist(
                    analytics["recently_played"]
                ),
                "most_played_track": self._get_most_played_track(
                    analytics["recently_played"]
                ),
            }
    ...
    def search_and_add_to_favorites(
        self, query: str, limit: int = 10
    ) -> Dict[str, Any]:
    ...
    def search_and_play_all(self, query: str, limit: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            self.play_music(first_track["uri"])
    ...
    def get_recently_played(self, limit: int = 20) -> Dict[str, List[Dict[str, Any]]]:
        ...
        try:
            ...
            if "403" in str(e) or "Insufficient client scope" in str(e):
                raise ValueError(
                    "Permissão insuficiente. Reautentique com escopo 'user-read-recently-played'"
                )
    ...
    def get_followed_artists(self, limit: int = 20) -> Dict[str, List[Dict[str, Any]]]:
        ...
        try:
            ...
            if "403" in str(e) or "Insufficient client scope" in str(e):
                raise ValueError(
                    "Permissão insuficiente. Reautentique com escopo 'user-follow-read'"
                )
